...
<div class="bg-[#D3D9D4] dark:bg-[#212A31] flex items-center justify-center h-screen">
    <div class="bg-white dark:bg-[#2E3944] p-8 rounded-2xl shadow-xl w-96 border border-[#BAB2B5] dark:border-[#124E66]">
        <?=loadComponent("WarningAlert",["msg"=> "To Reset Your Password, Please Check Your Email Address. An Email has been sent to you!!!"])?>
        ...
        <form class="mt-6" method="post" action="/reset-password">
            <div>
                ...
                <input required type="email" class="poppins-regular w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#124E66] dark:bg-[#D3D9D4] dark:text-black dark:border-[#D3D9D4]" placeholder="Enter your email">
            </div>
            <div class="mt-4 relative">
                <label class="block text-[#212A31] dark:text-[#D3D9D4] font-medium poppins-regular">Password</label>
                <input required type="password" class="poppins-regular w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#124E66] dark:bg-[#D3D9D4] dark:text-black dark:border-[#D3D9D4]" placeholder="Enter your password">
                <?=loadComponent("EyeIcons") ?>
            </div>
            <div class="mt-4 relative">
                <label class="block text-[#212A31] dark:text-[#D3D9D4] font-medium poppins-regular">Confirm Password</label>
                <input required type="password" class="poppins-regular w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#124E66] dark:bg-[#D3D9D4] dark:text-black dark:border-[#D3D9D4]" placeholder="Confirm your password">
                <?=loadComponent("EyeIconsConfirm") ?>
            </div>
            <div class="mt-4">
                <label class="block text-[#212A31] dark:text-[#D3D9D4] font-medium poppins-regular">Code</label>
                <input required type="tel" class="poppins-regular w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#124E66] dark:bg-[#D3D9D4] dark:text-black dark:border-[#D3D9D4]" placeholder="Enter your code">
            </div>
